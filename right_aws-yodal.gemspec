Gem::Specification.new do |s|
  s.name = %q{right_aws-yodal}
  s.version = "1.10.11"
 
  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["RightScale, Inc.","Yodal"]
  s.date = %q{2009-04-06}
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/awsbase/benchmark_fix.rb", "lib/awsbase/right_awsbase.rb", "lib/awsbase/support.rb", "lib/ec2/right_ec2.rb", "lib/ec2/right_ec2_ebs.rb", "lib/ec2/right_ec2_images.rb", "lib/ec2/right_ec2_instances.rb", "lib/ec2/right_ec2_monitoring.rb", "lib/ec2/right_ec2_reserved_instances.rb", "lib/ec2/right_ec2_vpc.rb", "lib/right_aws.rb", "lib/s3/right_s3.rb", "lib/s3/right_s3_interface.rb", "lib/sdb/active_sdb.rb", "lib/sdb/right_sdb_interface.rb", "lib/sqs/right_sqs.rb", "lib/sqs/right_sqs_gen2.rb", "lib/sqs/right_sqs_gen2_interface.rb", "lib/sqs/right_sqs_interface.rb", "lib/acf/right_acf_interface.rb", "lib/elb/right_elb_interface.rb", "lib/as/right_as_interface.rb", "lib/acw/right_acw_interface.rb", "test/ec2/test_helper.rb", "test/ec2/test_right_ec2.rb", "test/http_connection.rb", "test/s3/test_helper.rb", "test/s3/test_right_s3.rb", "test/s3/test_right_s3_stubbed.rb", "test/sdb/test_active_sdb.rb", "test/sdb/test_helper.rb", "test/sdb/test_right_sdb.rb", "test/sqs/test_helper.rb", "test/sqs/test_right_sqs.rb", "test/sqs/test_right_sqs_gen2.rb", "test/test_credentials.rb", "test/ts_right_aws.rb", "test/acf/test_helper.rb", "test/acf/test_right_acf.rb", "lib/rds/right_rds_interface.rb", "lib/acf/right_acf_origin_access_identities.rb", "lib/acf/right_acf_streaming_interface.rb", "lib/ec2/right_ec2_security_groups.rb", "lib/ec2/right_ec2_spot_instances.rb", "test/sdb/test_batch_put_attributes.rb" ]
  s.has_rdoc = true
